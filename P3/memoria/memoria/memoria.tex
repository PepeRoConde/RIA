...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\linewidth]{../diagramas/marce.png}
    ...
    Si no se ve al objeto, tomará el control el \textcolor{violet}{modelo telecontrol}, si no la \textcolor{cyan}{política adaptada de la Práctica 1}. hola}
    \label{fig:diagrama}
\end{figure}
...
\begin{itemize}
	\item \emph{\textcolor{violet}{Modelo Telecontrol:}}
	\item \emph{\textcolor{cyan}{Modelo con pólitica de la P1:}}
\end{itemize}
